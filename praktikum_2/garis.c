 ...
 * NIM		: 13518031
 * Tanggal	: 31/08/2019
 * Deskripsi: Realisasi prosedur dan fungsi ADT garis yang menggunakan ADT point 
 */
...
/* Menghitung panjang garis L : PAkhir(L)-PAwal(L) atau menggunakan fungsi panjang dari point.h
 * 								Panjang(PAkhir(L),PAwal(L))*/
{
